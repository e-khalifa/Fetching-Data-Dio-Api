...
class ColorUtility {
  static const main = Colors.purpleAccent;
  static const secondary = Color.fromARGB(255, 245, 216, 250);
  static const softPurple = Color.fromARGB(255, 253, 253, 253);
  static const purple = Color.fromARGB(255, 235, 169, 247);
